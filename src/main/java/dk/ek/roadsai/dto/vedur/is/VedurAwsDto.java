...
public class VedurAwsDto {
    ...
    public static class Aws10minBasic {
        ...
        @JsonProperty("time")       public String time;   // local ISO without zone (ex: 2025-11-05T21:40:00)
        @JsonProperty("t")          public Double t;      // temp °C
        @JsonProperty("f")          public Double f;      // wind m/s (mean)
        @JsonProperty("fg")         public Double fg;     // gust m/s
        @JsonProperty("vis")        public Double vis;    // visibility m (nullable)
        @JsonProperty("precip")     public String precip; // precipitation code/text (nullable)
    }
